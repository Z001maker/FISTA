...
if __name__ == "__main__":
    ...
    for lambda_ in lambdas:
        ...
        reconstruction_l1 = reconstruction_l1 / 255.0
        ssim_l1 = ssim(image, reconstruction_l1, data_range=1)
        #ssim_l1 = ssim(image, reconstruction_l1, data_range=1.0)
        ...
        reconstruction_tv = reconstruction_tv / 255.0
        ssim_tv = ssim(image, reconstruction_tv, data_range=1)
